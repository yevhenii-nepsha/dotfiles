...
-- Ukrainian keyboard layout mapping for normal/visual mode
-- Allows using Ukrainian keyboard for vim commands without switching to English
-- Maps Ukrainian characters to their English QWERTY equivalents
vim.cmd([[
